      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        {isSuccess ? (
          <motion.div 
            ...
            className="bg-white  rounded-[32px] p-8 sm:p-12 shadow-xl border border-[#EAEAEA]  text-center"
          >
            <div className="w-24 h-24 bg-[#EFFCF6]  rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm border-4 border-white  ring-4 ring-[#55C990]/10">
              <CheckCircle2 className="w-12 h-12 text-[#55C990]" />
            </div>
            <h2 className="text-3xl font-black text-[#101B3D]  mb-4 tracking-tight">You're Awesome! 🎉</h2>
            <p className="text-[#8C8C8C]  font-semibold text-base sm:text-lg mb-8 max-w-sm mx-auto leading-relaxed">
              Thanks for filling out the form! Our team will review it shortly. Your ideas help make the platform better for everyone.
            </p>
            <button 
              onClick={onBack}
              className="px-8 py-4 bg-[#101B3D]  text-white rounded-xl font-bold hover:bg-[#1A2A5E]  transition-colors shadow-lg active:scale-95 inline-flex items-center gap-2"
            >
              <ArrowLeft className="w-4 h-4" />
          ...
          <div className="bg-white  rounded-[32px] p-6 sm:p-12 shadow-xl border border-[#EAEAEA] ">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-black text-[#101B3D] ">Feedback & Suggestions</h1>
