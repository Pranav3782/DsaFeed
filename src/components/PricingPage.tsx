...
export const PricingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[400px] bg-gradient-to-b from-[#EEF4FF] to-[#FAFAFA] pointer-events-none" />
      <div className="absolute top-20 right-10 w-72 h-72 bg-[#3478E5]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-[#F5C94A]/10 rounded-full blur-3xl pointer-events-none" />
